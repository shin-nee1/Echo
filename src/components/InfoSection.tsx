  ...
  return (
    <section className="relative w-full bg-transparent overflow-hidden info-section-wrapper">
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .info-image-side { width: 55%; display: flex; justify-content: center; align-items: center; }
        ...
        @media (min-width: 1024px) {
          ...
          /* CHANGED: align-items to center for perfect 50% vertical alignment */
          ...
          /* CHANGED: Removed padding-top so it doesn't push the image off-center */
        ...
        .info-image-side {
          ...
          align-items: center; /* Added to enforce vertical centering */
          padding-right: 3vw; 
        }
      `}} />
    </section>
