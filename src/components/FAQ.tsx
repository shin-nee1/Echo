...
// Optional: import the type if you want strict typing
import type { FAQItem } from "@/data/faqData2";
...
const FAQ: React.FC<FAQProps> = ({ items }) => {
  // Graceful fallback if no FAQs are provided
  ...
  return (
    <section className="relative bg-transparent overflow-hidden font-sans z-10 faq-section">
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .faq-glass-card { border-radius: 1rem; height: auto; } /* Removed min-height */
        ...
        @media (min-width: 2560px) {
          ...
          .faq-glass-card { border-radius: 2rem; } 
